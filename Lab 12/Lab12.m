...
walls = [0, 0, 48*0.0254, 0; 0, 0, 0, 48*0.0254; 48*0.0254, 0, 48*0.0254, 48*0.0254];
...
function [poseout, goalposeout] = moveAbsPos(targetPose, vMax, currentPose, ~)
    th = -currentPose(3);
    ...
    [poseout, goalposeout] = moveRelPos(dx, dy, dth, vMax, currentPose, currentPose);
end
